...
<div className="bg-gray-100 h-screen flex p-4">
  <div className="w-1/2 flex items-center justify-center">
    <div className="text-black text-center">
      <h1 className="text-5xl font-epilogue font-bold mb-4 flex items-start">Your</h1>
      <h1 className="text-5xl font-epilogue font-bold mb-4 flex items-start pb-6">Tagline here</h1>
      <p className="text-lg pr-4 text-left pb-8">
        Welcome to the Bhashini Web Translation Plugin, your gateway to seamless
        language translation and communication. Powered by Bhashini, our plugin
  ...
  <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6 justify-center">
    {principlesData.map((principle, index) => (
      <div key={index} className="bg-white rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
        <div className="p-4">
          <img src={principle.image} alt={principle.principle} className="w-24 h-24 object-cover object-center mx-auto mb-4 rounded-full" />
