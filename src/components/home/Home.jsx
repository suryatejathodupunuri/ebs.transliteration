...
<div className="bg-gray-50 h-screen flex p-4">
  <div className="w-1/2 flex items-center justify-center">
    <div className="text-black text-center">
      <h1 className="text-5xl font-epilogue font-bold mb-4 flex items-start">Make</h1>
      <h1 className="text-5xl font-epilogue font-bold mb-4 flex items-start pb-6">Remote work</h1>
